...
do
    ...
    do
        ...
        if [[ ! -f "00.${SBJ}_${SES}_task-breathhold_meica-cons_bold_native_preprocessed.dt.nii.gz" ]]; then
            ...
            3dTproject -overwrite -input 00.${SBJ}_${SES}_task-breathhold_optcom_bold_native_preprocessed.nii.gz \
                ...
                -prefix 00.${SBJ}_${SES}_task-breathhold_meica-cons_bold_native_preprocessed.dt.nii.gz

            3dTstat -mean -prefix rm.mean.nii.gz \
                00.${SBJ}_${SES}_task-breathhold_optcom_bold_native_preprocessed.nii.gz -overwrite

            3dcalc -a 00.${SBJ}_${SES}_task-breathhold_meica-cons_bold_native_preprocessed.dt.nii.gz \
                -b rm.mean.nii.gz -m ${SBJ}_ses-01_task-breathhold_rec-magnitude_echo-1_sbref_brain_mask.nii.gz \
                -expr 'm*(a+b)' \
                -prefix 00.${SBJ}_${SES}_task-breathhold_meica-cons_bold_native_preprocessed.dt.nii.gz -overwrite
